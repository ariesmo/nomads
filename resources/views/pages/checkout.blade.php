                         ...
                         <div class="card card-details">
                                 ...
                                 <table class="table table-responsive-sm text-center">
                                     ...
                                     <tbody>
                                         @forelse ($item->detail as $detail)
                                            <tr>
                                                <td><img src="http://ui-avatars.com/api/?name{{ $detail->username }}" alt="" height="60"></td>
                                                ...
                                                <td class="align-middle"><a href="{{ route('checkout-remove', $detail->id) }}"><img src="{{ url('frontend/images/icon/close.png') }}" alt="" height="20" class="rounded-circle"></a></td>
                                            </tr>
                                         @empty
                                            <tr>
                            ...
                            <div class="member mt-3">
                                ...
                                <form action="{{ route('checkout-create', $item->id) }}" class="form-inline" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-2 mr-sm-2" style="width: 130px" name="username" id="username" placeholder="Username" requir>
                                    <label for="nationality" class="sr-only">Nationality</label>
                                    <input type="text" class="form-control mb-2 mr-sm-2" style="width: 130px" name="nationality" id="nationality" placeholder="Nationality" required>
                         ...
                         <div class="card card-details card-right">
                             ...
                             <table class="trip-informations">
                                 ...
                                 <tr>
                                     ...
                                     <td width="50%" class="text-right text-total"><span class="text-blue">$ {{ $item->transaction_total }},</span><span class="text-orange">{{ mt_rand(0,99) }}</span> / person</td>
                                 </tr>
                             </table>
                             <hr>
                             <h2>Payment Instructions</h2>
                             <p class="payment-instructions">Please complete your payment before you continue the wonderful trip</p>
                             <div class="bank">
...
$(document).ready(function(){
    $('.datepicker').datepicker({
        ...
        icons: {
           rightIcon:  '<img src="{{ url('frontend/images/icon/calendar.png') }}" height="20" width="20"/>'
        }
    });
});
