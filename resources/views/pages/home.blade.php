                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-8 text-center">
                                <img src="{{ url('frontend/images/network/Group_network.png') }}" alt="" class="img-partner">
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="section-popular-travel row justify-content-center">
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                <div class="card card-testimonial text-center">
                                    <div class="testimonial-content">
                                        <img src="{{ url('frontend/images/testimoni/Group_testimoni1.png') }}" alt="" class="mb-4 rounded-circle" height="120px">
                                        <h3 class="mb-4">Angga Rizky</h3>
                                        <p class="testimonial text-center">“ It was glorious and I could
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                <div class="card card-testimonial text-center">
                                    <div class="testimonial-content">
                                        <img src="{{ url('frontend/images/testimoni/Group_testimoni2.png') }}" alt="" class="mb-4 rounded-circle" height="120px">
                                        <h3 class="mb-4">Angga Rizky</h3>
                                        <p class="testimonial text-center">“ The trip was amazing and
                                                    I saw something beautifull in
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                <div class="card card-testimonial text-center">
                                    <div class="testimonial-content">
                                        <img src="{{ url('frontend/images/testimoni/Group_testimoni3.png') }}" alt="" class="mb-4 rounded-circle" height="120px">
                                        <h3 class="mb-4">Angga Rizky</h3>
                                        <p class="testimonial text-center">“ I loved it when the waves
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                ...
                                <a href="{{ url('register') }}" class="btn btn-get-started px-4 mt-4 mx-1">Get Started</a>
                            </div>
